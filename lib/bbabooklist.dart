...
//import 'package:bookshairing/navigatorpage.dart'; // if navigator page needed
...
class bbabooklist extends StatefulWidget {
  const bbabooklist({super.key});

  @override
  State<bbabooklist> createState() => _csebooklistState();
}

class _csebooklistState extends State<bbabooklist> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: _firestore
            ...
            .where("section",
                isEqualTo: "BBA") // This line is for subcatagories.
            .snapshots(),
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ListView(
            children: snapshot.data!.docs.map((DocumentSnapshot document) {
              ...
              //String ownerEmail = document.ownerEmail;
              return Padding(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          Text(
                            limitCharacters(
                                data["Tittle"], 20), //Text(data["Tittle"],
                            style: TextStyle(
