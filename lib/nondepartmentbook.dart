...
class nondepartmentbook extends StatefulWidget {
  const nondepartmentbook({super.key});

  @override
  State<nondepartmentbook> createState() => _csebooklistState();
}

class _csebooklistState extends State<nondepartmentbook> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("NON-DEPARTMENT"),
        backgroundColor: Color(0xff199ee9),
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: _firestore
        .collectionGroup("book")
        .where("section", isEqualTo: "NON-DEPARTMENT")
        .snapshots(),
                ...
                child: Container(
                  decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        colors: [Colors.blue,Colors.lightBlue.shade100,Colors.blue,],
                        ),
                      ),
                    child: Row(
                      children: [
